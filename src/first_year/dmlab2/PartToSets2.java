...
public class PartToSets2 {
    ...
    public static void main(String[] args) throws Exception {
        String destinationFileName = "PartToSets.out";
        FileOutputStream fileOutputStream = new FileOutputStream(destinationFileName);
        FileWriter writer = new FileWriter("PartToSets.out", true);
        FastScanner in = new FastScanner(new File("PartToSets.in"));
        int n = in.nextInt();
        int k = in.nextInt();
