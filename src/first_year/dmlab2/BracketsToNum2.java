...
public class BracketsToNum2 {
    ...
    public static void main(String[] args) throws Exception {
        String destinationFileName = "BracketsToNum2.out";
        FileOutputStream fileOutputStream = new FileOutputStream(destinationFileName);
        FileWriter writer = new FileWriter("BracketsToNum2.out", true);
        FastScanner in = new FastScanner(new File("BracketsToNum2.in"));
        int n = 20;
