...
public class NumToBrackets {
    ...
    public static void main(String[] args) throws Exception {
        String destinationFileName = "NumToBrackets.out";
        FileOutputStream fileOutputStream = new FileOutputStream(destinationFileName);
        FileWriter writer = new FileWriter("NumToBrackets.out", true);
        FastScanner in = new FastScanner(new File("NumToBrackets.in"));
