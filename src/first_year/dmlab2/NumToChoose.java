...
public class NumToChoose {
    ...
    public static void main(String[] args) throws Exception {
        String destinationFileName = "NumToChoose.out";
        FileOutputStream fileOutputStream = new FileOutputStream(destinationFileName);
        FileWriter writer = new FileWriter("NumToChoose.out", true);
        FastScanner in = new FastScanner(new File("NumToChoose.in"));
