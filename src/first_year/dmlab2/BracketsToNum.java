...
public class BracketsToNum {
    ...
    public static void main(String[] args) throws Exception {
        String destinationFileName = "BracketsToNum.out";
        FileOutputStream fileOutputStream = new FileOutputStream(destinationFileName);
        FileWriter writer = new FileWriter("BracketsToNum.out", true);
        FastScanner in = new FastScanner(new File("BracketsToNum.in"));
        int n = 20;
